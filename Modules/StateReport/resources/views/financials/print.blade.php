...
<head>
    ...
    <title>Laporan Keuangan {{ $report->year }}</title>
    <style>
...
<body>
    ...
    <main>
        <table class="header-table">
            <tr>
                ...
                <td class="header-right">
                    ...
                    <p class="doc-no">#FIN-{{ str_pad($report->id, 5, '0', STR_PAD_LEFT) }}</p>
                    ...
                    <table class="meta-table">
                        ...
                        <tr>
                            ...
                            <td class="meta-val">{{ $report->year }}</td>
                        </tr>
                        <tr>
                            <td class="meta-label">Periode:</td>
                            <td class="meta-val">{{ $report->period }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <div class="notes-box">
            <p class="notes-title">RINGKASAN &amp; CATATAN LAPORAN KEUANGAN</p>
            <div class="notes-text">
                @if($report->notes)
                    {!! nl2br(e($report->notes)) !!}
                @else
                    <i>Tidak ada catatan khusus untuk periode pelaporan ini.</i>
                @endif
            </div>
        </div>
        ...
        <table class="bottom-table" style="margin-top: 40px;">
            <tr>
                ...
                <td style="width: 50%;" class="sig-box">
                    ...
                    <div class="qr-code">
                        <img src="data:image/svg+xml;base64,{!! base64_encode(\SimpleSoftwareIO\QrCode\Facades\QrCode::format('svg')->size(75)->margin(0)->generate('Dokumen Resmi PT Fluxa - Laporan Keuangan ' . $report->year)) !!}" alt="QR Code">
                    </div>
                    <div class="sig-line"></div>
                    <p class="sig-name">Manajemen Keuangan</p>
