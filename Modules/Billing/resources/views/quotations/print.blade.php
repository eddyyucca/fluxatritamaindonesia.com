...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .doc-label {
            font-size: 28pt; font-weight: 900; color: #1a1a2e;
            letter-spacing: -1.2px; line-height: 1; text-transform: uppercase;
        }
        .doc-number { font-size: 11pt; font-weight: 700; color: #1a1a2e; margin-top: 2px; letter-spacing: 0.01em; }
        .doc-meta { font-size: 7.5pt; color: #666; margin-top: 5px; line-height: 1.75; }
        .quoted-label {
            font-size: 7pt; font-weight: 800; color: #999;
            text-transform: uppercase; letter-spacing: 0.1em;
            margin-top: 10px; margin-bottom: 1px;
        }
        .quoted-name {
            font-size: 16pt; font-weight: 900; color: #1a1a2e;
            letter-spacing: -0.4px; line-height: 1.1;
        }
        .quoted-address { font-size: 7pt; color: #666; margin-top: 2px; line-height: 1.6; }
        ...
        .payment-total-row {
            ...
            padding: 10px 0; border-top: 1px solid #d1d5db;
        }
        ...
        /* ── SIGNATURE + QR ── */
        .sig-area { display: flex; justify-content: space-between; align-items: flex-end; margin-top: 12px; margin-bottom: 10px; }
        .sig-name { font-size: 8pt; font-weight: 700; color: #333; }
        .sig-role { font-size: 7pt; color: #888; margin-top: 1px; }
        .approval-stamp { display: inline-block; border: 2px solid #059669; border-radius: 4px; padding: 3px 7px; text-align: center; margin-top: 5px; }
        ...
        /* Two-tone decorative footer bar */
...
<body>
    ...
    <div class="page">
        ...
        <div class="header">
            ...
            <div class="doc-right-block">
                ...
                <div class="doc-meta">
                    ...
                    Berlaku s/d : {{ $quotation->valid_until->format('d/m/Y') }}
                    @endif
                </div>
                <div class="quoted-label">QUOTED TO</div>
                <div class="quoted-name">{{ strtoupper($quotation->client->name) }}</div>
                @if($quotation->client->address || $quotation->client->city)
                <div class="quoted-address">
        ...
        <div class="project-info">
            <strong>Proyek:</strong> {{ $quotation->title }}
            @if($quotation->description)
            <br><span>{{ $quotation->description }}</span>
            @endif
        </div>
        @endif
        ...
        <div class="payment-total-row">
            <div>
                ...
                <div class="payment-row"><span class="lbl">NAME</span><span>:</span><span>PT FLUXA TRITAMA INDONESIA</span></div>
                <div class="payment-row"><span class="lbl">BANK</span><span>:</span><span>MANDIRI</span></div>
                <div class="payment-row"><span class="lbl">No. Rekening</span><span>:</span><span>031 00 2387227 1</span></div>
            </div>
            <div class="total-block">
                <span class="total-label-text">TOTAL</span>
                <span class="total-amount-text">Rp{{ number_format($quotation->total, 0, ',', '.') }}</span>
            </div>
        </div>
        ...
        <div class="sig-area">
            <div>
                ...
                <div class="approval-stamp" style="margin-top:6px;">
