...
<body class="min-h-screen flex flex-col relative overflow-x-hidden">
    ...
    <!-- Main Content -->
    <div class="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full flex flex-col lg:flex-row gap-8">
    ...
    <footer class="w-full border-t border-white/10 mt-auto bg-slate-900/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center text-slate-400 text-sm">
